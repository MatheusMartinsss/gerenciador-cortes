                ...
                return (
                    <div className="flex space-x-1 2xl:space-x-8  items-center justify-center " key={item.id} >
                        ...
                        <div >
                            ...
                            <Input {...register(`tree.${nestIndex}.sections.${k}.section`)} />
                        </div>
                        <div >
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <Input
                                        ...
                                        value={maskToMeters(field.value)}
                                        onChange={(e) => {
                                            setValue(`tree.${nestIndex}.sections.${k}.d4`, unMask(e.target.value))
                                            field.onChange(unMask(e.target.value))
                                        }}
                                    >
                                    </Input>
...
const SubTotal = ({ nestIndex, idx, control, setValue }: {
    ...
    const watch = useWatch({
        control,
        name: `tree.${nestIndex}.sections.${idx}`
    })
    ...
    useEffect(() => {
        ...
        setValue(`tree.${nestIndex}.sections.${idx}.volumeM3`, Math.ceil((volumeM3 * 1000)))
    }, [d1, d2, d3, d4, meters])
    ...
    return <Controller
        name={`tree.${nestIndex}.sections.${idx}.volumeM3`}
        control={control}
        render={({ field }) => (
            <Input
                {...field}
