...
import { FindAllCompanyResponse, findAllCompanys } from "@/services/companyService"
...
export const CompanyTable = () => {
    ...
    const { data: response, isLoading, isError } = useQuery<FindAllCompanyResponse>({
        queryKey: ['company', page, orderBy, order],
        queryFn: async () => await findAllCompanys({ page: Number(page), orderBy, order }),
